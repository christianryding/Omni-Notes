...
public class HtmlDocument extends Document {
    ...
    @Override
    protected void contactName(String nameLabel, String first, String last) {

    }

    @Override
    protected void contactPhone(String phoneLabel, String phone) {

    }

    @Override
    protected void contactEmail(String emailLabel, String email) {
